...
$('#acecrew_session_add_form #field-job-session-comment-items').hide();
    $('#acecrew_session_add_form #field-job-session-comment-items').before('<button id="show_comments" type="button">View Comments</button>');
	    $('#show_comments').click(function(){
        $('#acecrew_session_add_form #edit-field-job-session-crews-field-job-session-crews-add-more').parent().hide();
        $('#acecrew_session_add_form #field-job-session-comment-items').show();
        return false;
    });

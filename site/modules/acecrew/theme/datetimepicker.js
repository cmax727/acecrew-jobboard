(function ($) {
	...
	function DateTimePicker(options) {
		...
		for (i = 1; i <= 24; i++) html1 = hourHTML.append("<option>" + pad.substring(0, pad.length - (""+i).length) + i + "</option");
		for (i = 0; i < 60; i = i + 5) html2 = minutsHTML.append("<option>" + pad.substring(0, pad.length - (""+i).length) + i + "</option");
		for (i = 0; i < 60; i = i + 5) html3 = secondHTML.append("<option>" + pad.substring(0, pad.length - (""+i).length) + i + "</option");
